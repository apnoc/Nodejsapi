...
module.exports = {
  ...
  contacts: (parent, args, { dataSources }, info) => {
    const allContacts = dataSources.contactDataSource.getContacts(args);
    return allContacts;
  },
  contactById: (parent, { id }, { dataSources }, info) => {
    const allContacts = dataSources.contactDataSource.getContactById(id);
    return allContacts;
  },
